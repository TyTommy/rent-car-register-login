...
import TechnicalInfo from '../../dashboard/create/technical-info/TechnicalInfo';
import CheckIn from '../../dashboard/create/check-in/CheckIn';
...
const Create = () => {
  ...
  return (
    <div>
      ...
      />
      <div className="h-[500px] flex pb-10">
